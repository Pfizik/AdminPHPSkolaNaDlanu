...
<body>
    ...
    <script>document.write("<script src='assets/initial.js?v=" + Date.now() + "'><\/script>");</script>
    <script>document.write("<script src='assets/calc.js?v=" + Date.now() + "'><\/script>");</script>
    <script>document.write("<script src='assets/manipulate.js?v=" + Date.now() + "'><\/script>");</script>
    <script>document.write("<script src='assets/writtesave.js?v=" + Date.now() + "'><\/script>");</script>
    <script>
